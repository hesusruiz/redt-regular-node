# Alastria Regular Node for Alastria RedT Network

**WARNING!! The documentation is work in progress. The system works but the documentation has not yet been updated. You can use this system to install and operate a Regular node but do not rely on the documentation yet.**

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](LICENSE)
[![Slack Status](https://img.shields.io/badge/slack-join_chat-white.svg?logo=slack)](https://alastria.slack.com/)

RedT is [Public-Permissioned](https://www.linkedin.com/pulse/public-permissioned-blockchain-manifesto-jesus-ruiz/) blockchain network operated collaboratively by members of the Alastria non-profit association. It is based on [GoQuorum](https://github.com/ConsenSys/quorum) and uses the [IBFT 1.0](https://docs.goquorum.consensys.net/en/stable/Concepts/Consensus/IBFT/) consensus algorithm.


[GoQuorum](https://github.com/ConsenSys/quorum) is a fork of [Geth](https://geth.ethereum.org/) (the Official Go implementation of the Ethereum protocol) from [Consensys](https://consensys.net/) that implements [Raft](https://docs.goquorum.consensys.net/en/stable/Concepts/Consensus/Raft/) and [IBFT](https://docs.goquorum.consensys.net/en/stable/Concepts/Consensus/IBFT/) consensus algorithms, and is licensed under the
[GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html)

There are 3 types of nodes in the Alastria RedT network.
...
Once the node is installed, connected to the network and operating successfully, the structure of the directory is the following:
...
This is the Docker compose file that starts the node 



# 1) Installation

The following process explain the installation for a Regular (also called _general_) node:

* Clone or download this repository to the machine where you want to install and operate the RedT node and enter into the cloned directory.
